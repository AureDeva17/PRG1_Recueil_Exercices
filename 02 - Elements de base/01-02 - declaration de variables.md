...
2.  
    ...
    int n = 1;
    n = n + 1;
    int n = 1 – 2 * n; //erreur, double déclaration
    ~~~
3. 
    ~~~cpp
    int n = 1, p = 2;
    n = (n + 1) * (n - k); //k n'est pas déclarée
    ~~~
4. 
    ~~~cpp
    int n, m = 0;
    n = 2 * n - 1;
    m = n + 1; //n n'est pas initialisée
    ~~~
 5. 
    ~~~cpp
    int n = 5, m = 0;
 ...
 6. 
    ...
    int n = 5, m = 0;
    const int nb_produit = 10;
    m = n * nb_produit--; //impossible de désincrémenté une constante   
    ~~~
