...
int main(){
    constexpr int nb_min = 0;

    //ask the numbers
    int nb1, nb2;
    do{
        int nb1_temp, nb2_temp;
        cout << "Donnez 2 nombres entiers positifs : ";
        cin >> nb1_temp >> nb2_temp;

        if (nb1_temp >= nb2_temp){
            nb1 = nb1_temp;
            nb2 = nb2_temp;
        }else{
            nb2 = nb1_temp;
    ...
    while(product1 != product2){
        product1 = nb1 * multiplicator1++;
        while(product2 < product1){
            product2 = nb2 * multiplicator2++;
        }
    }

    cout << "ppmc(" << nb1 << "," << nb2 << ") = " << product1;
